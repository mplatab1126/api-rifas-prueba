// shared-footer.jsx — Footer institucional unificado
// Idéntico en todas las páginas. Carga después de React/ReactDOM.
  ...
  return (
    <footer className="sf-footer">
      ...
      <div className="sf-info">
        <p className="sf-nombre">LOS PLATA S.A.S.</p>
        <p className="sf-line">NIT 902.003.134-4</p>
        <p className="sf-line">Carrera 6 #12-04 local 2</p>
        <p className="sf-line">Chinchiná, Caldas</p>
      </div>
      <div className="sf-redes">
      ...
      <p className="sf-copy">© 2026 LOS PLATA S.A.S.</p>
    </footer>
  );
}
