// comprar-icons.jsx — \u00cdconos para el flujo de compra

window.CompIcon = ({ name, size = 24, color = "currentColor" }) => {
  const s = size;
  switch (name) {
    case "back":
      return (
    ...
    case "x":
      return (
        <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
