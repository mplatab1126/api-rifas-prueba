...
const fechaStr = fechaObj.toLocaleDateString('es-CO', opcionesFecha) + ' ' + fechaObj.toLocaleTimeString('es-CO', opcionesHora);
 ...
 // Variables globales para los filtros
    ...
    const SUBCATEGORIAS = {
        ...
        rifa_santa_teresita_3: ['Publicidad', 'Adecuación', 'Muebles', 'Electrodomésticos', 'Acabados', 'Premios', 'Devoluciones a Clientes', 'Otros'],
    ...
    function htmlFilaDist(itemId, idx, monto, desc, prefix) {
        ...
        const catOpts = '<option value="">— Categoría * —</option><option value="operacionales">⚙️ Operacionales</option><option value="rifa_apartamento">🏠 Rifa Apartamento</option><option value="construccion">🏗️ Construcción</option><option value="rifa_camioneta">🚗 Rifa Camioneta</option><option value="rifa_santa_teresita">🏡 Rifa Santa Teresita</option><option value="rifa_santa_teresita_2">🏡 Rifa Santa Teresita 2</option><option value="rifa_santa_teresita_3">🏡 Rifa Santa Teresita 3</option><option value="retiro_ganancia">💸 Retiro Ganancia</option><option value="retiro_capital">🏦 Retiro de Capital</option><option value="movimiento_caja">💵 Movimiento a Caja</option>';
    ...
    function recogerDistribuciones(itemId, prefix) {
        ...
        if (!container) return [];
        const rows = container.querySelectorAll('.dist-row');
        const nombresCat = { operacionales: 'Operacionales', rifa_apartamento: 'Rifa Apartamento', construccion: 'Construcción', rifa_camioneta: 'Rifa Camioneta', rifa_santa_teresita: 'Rifa Santa Teresita', rifa_santa_teresita_2: 'Rifa Santa Teresita 2', rifa_santa_teresita_3: 'Rifa Santa Teresita 3', retiro_ganancia: 'Retiro de Ganancia', retiro_capital: 'Retiro de Capital' };
        const result = [];
        rows.forEach(row => {
            const idx = row.id.split('_').pop();
